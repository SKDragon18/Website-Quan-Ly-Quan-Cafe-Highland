			...
			<div class="container-fluid px-4">
				<div class="card-header">
					<label class="font-weight-bold"
						style="font-size: 20px; color: #800000">QUẢN LÝ CHI TIẾT SẢN PHẨM</label>
				</div>
				<div class="card-header">
					<form:form class="row g-3" modelAttribute="chitiet"
						...
						<c:if test="${btnStatus=='btnAdd'}">
							<div class="col-md-4">
								...
								<form:select path="pk.SANPHAM.MASP" items="${cacsanpham}" itemValue="MASP" itemLabel="TEN"  class="form-control"
								id="sanpham"/>
							</div>
						</c:if>
						<c:if test="${btnStatus=='btnEdit'}">
							...
							<div class="col-md-4">
								<label class="font-weight-bold">Sản phẩm</label>
								<form:select path="pk.SANPHAM.MASP" disabled="true" items="${cacsanpham}" itemValue="MASP" itemLabel="TEN"  class="form-control"
								id="sanpham"/>
							</div>
						</c:if>
						<c:if test="${btnStatus=='btnAdd'}">
						...
						<c:if test="${btnStatus=='btnEdit'}">
							...
							<div class="col-md-4">
								<label class="font-weight-bold">Size</label>
								<form:select path="pk.SIZE.MASIZE" disabled="true" items="${cacsize}" itemValue="MASIZE" itemLabel="TENSIZE"  class="form-control"
								id="size"/>
							</div>
						</c:if>
						<div class="col-md-4">
						...
						<div class="col-md-4">
							...
							<form:input path="GIAHIENTHOI" type="number" min='100' step='100' placeholder='VNĐ' class="form-control"
								id="exampleFormControlInput1" />
