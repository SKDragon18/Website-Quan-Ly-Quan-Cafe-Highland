					...
					<form:form class="row g-3" modelAttribute="size"
						...
						<c:if test="${btnStatus=='btnAdd'}">
							<div class="col-md-4">
								...
								<form:input path="MASIZE" type="text" maxlength="5" placeholder="Chỉ nhập số và chữ" class="form-control"
									id="masize" />
						...
						<div class="col-md-4">
							...
							<form:input path="TENSIZE" type="text" maxlength="15" placeholder="Chỉ nhập số và chữ" class="form-control"
