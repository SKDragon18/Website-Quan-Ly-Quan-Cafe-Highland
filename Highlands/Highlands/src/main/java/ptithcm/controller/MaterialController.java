...
public class MaterialController {
	...
	public boolean kiemTraMaNL(String mANL) {
		Pattern pattern = Pattern.compile("^NL\\d+$", Pattern.CASE_INSENSITIVE);
	    Matcher matcher = pattern.matcher(mANL);
	...
	public String edit_NguyenLieu(ModelMap model,  @ModelAttribute("nguyenlieu") NguyenLieu nguyenlieu, BindingResult errors) {
		...
		if(nguyenlieu.getTEN().isBlank()) {
			errors.rejectValue("TEN", "nguyenlieu", "Vui lòng nhập tên");
		}
	...
	public String addNguyenLieu(ModelMap model,@ModelAttribute("nguyenlieu") NguyenLieu nguyenlieu, BindingResult errors) {
		...
		else if(!kiemTraMaNL(nguyenlieu.getMANL())) {
			errors.rejectValue("MANL", "nguyenlieu", "Vui lòng nhập đúng dạng chuẩn: NL + số");
		}
		else nguyenlieu.setMANL(nguyenlieu.getMANL().toUpperCase());
		if(nguyenlieu.getTEN().isBlank()) {
			errors.rejectValue("TEN", "nguyenlieu", "Vui lòng nhập tên");
		}
		if(nguyenlieu.getDONVI().isBlank()) {
