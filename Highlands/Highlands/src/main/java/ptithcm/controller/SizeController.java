...
public class SizeController {
	...
	public boolean kiemTraHopLe(String chuoi) {
	...
	public String edit_Size(ModelMap model,   @ModelAttribute("size") Size size, BindingResult errors) {
		...
		else if(!kiemTraHopLe(size.getTENSIZE())) {
			errors.rejectValue("TENSIZE", "size","Vui lòng không nhập ký tự đặc biệt");
		}
		if(!errors.hasErrors()) {
	...
	public String addSize(ModelMap model,  @ModelAttribute("size") Size size, BindingResult errors) {
		...
		else if(!kiemTraHopLe(size.getMASIZE())) {
			errors.rejectValue("MASIZE", "size","Vui lòng không nhập ký tự đặc biệt");
		}
		else size.setMASIZE(size.getMASIZE().toUpperCase());
		if(size.getTENSIZE().isBlank()) {
			errors.rejectValue("TENSIZE", "size","Vui lòng nhập tên");
		}
		else if(!kiemTraHopLe(size.getTENSIZE())) {
