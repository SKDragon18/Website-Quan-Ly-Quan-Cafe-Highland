					...
					<form:form class="row g-3" modelAttribute="chitiet"
						...
						<c:if test="${btnStatus=='btnEdit'}">
							...
							<div class="col-md-4">
								...
								<p class="form-control">"${chitiet.pk.CT_SANPHAM.pk.SANPHAM.TEN}"
						...
						<form:hidden path="pk.CT_SANPHAM.pk.SANPHAM.TEN" />
						<form:hidden path="pk.CT_SANPHAM.pk.SIZE.TENSIZE" />
						<c:if test="${btnStatus=='btnAdd'}">
						<div class="col-md-4">
							<label class="font-weight-bold">Nguyên liệu</label><br>
							<form:select path="pk.NGUYENLIEU.MANL" items="${cacnguyenlieu}"
								itemValue="MANL" itemLabel="TEN" class="form-control"
						...
						<div class="col-md-4">
							<label class="font-weight-bold">Nguyên liệu</label><br>
							<form:select path="pk.NGUYENLIEU.MANL" items="${cacnguyenlieu}"
								itemValue="MANL" itemLabel="TEN" disabled="true" class="form-control"
								id="exampleFormControlInput1" />
						</div>
						</c:if>
						<div class="col-md-4">
							<label class="font-weight-bold">Số lượng</label>
							<form:input path="SOLUONG" type="number" min='0.01' step='0.01'
